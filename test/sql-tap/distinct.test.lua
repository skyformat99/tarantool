...
test:do_execsql_test(
    ...
    [[
        ...
        CREATE UNIQUE INDEX i2 ON t1(d COLLATE unicode_s1);
        ...
        CREATE UNIQUE INDEX t4i2 ON t4(d COLLATE unicode_s1);
    ]])
local data = {
    ...
    {"13.1", 0, "SELECT DISTINCT a, b, c COLLATE unicode_s1 FROM t1"},
    {"13.2", 0, "SELECT DISTINCT a, b, c COLLATE unicode_s1 FROM t4"},
    {"14.1", 0, "SELECT DISTINCT a, d COLLATE unicode_s1 FROM t1"},
    {"14.2", 1, "SELECT DISTINCT a, d COLLATE unicode_s1 FROM t4"},
...
test:do_execsql_test(
    ...
    [[
        ...
        CREATE INDEX i2 ON t1(b COLLATE unicode_s1, c COLLATE unicode_s1);
...
data = {
    ...
    {"a FROM t1", {}, {"A", "a"}},
    {"b COLLATE unicode_s1 FROM t1", {}, {"B"}},
    {"b COLLATE unicode_s1 FROM t1 ORDER BY b COLLATE unicode_s1", {}, {"B"}},
}
