...
test:do_execsql_test(
    "e_expr-9.10",
    [[
        SELECT  'abcd' =  'ABCD'  COLLATE unicode_s1
    ]], {
        -- <e_expr-9.10>
        1
        -- </e_expr-9.10>
...
test:do_execsql_test(
    "e_expr-9.14",
    [[
        SELECT  'abcd' IS 'ABCD'  COLLATE unicode_s1
    ]], {
        -- <e_expr-9.14>
        1
        -- </e_expr-9.14>
...
test:do_execsql_test(
    "e_expr-9.20",
    [[
        SELECT  'abcd' IS NOT 'ABCD'  COLLATE unicode_s1
    ]], {
        -- <e_expr-9.20>
        0
        -- </e_expr-9.20>
...
test:do_execsql_test(
    "e_expr-9.22",
    [[
        SELECT 'bbb' BETWEEN 'AAA' AND 'CCC' COLLATE unicode_s1
    ]], {
        -- <e_expr-9.22>
        1
        -- </e_expr-9.22>
