...
test:do_select_tests(
    "e_select-0.6",
    {
        ...
        {"2", "SELECT b||a FROM t1 ORDER BY (b||a) COLLATE unicode_s1", {"onea", "threec", "twob"}},
...
if (0 > 0)
 then
    ...
    test:do_execsql_test(
        "e_select-1.6.0",
        [[
            CREATE TABLE t5(a COLLATE unicode_s1, b COLLATE binary);
            INSERT INTO t5 VALUES('AA', 'cc');
            INSERT INTO t5 VALUES('BB', 'dd');
            INSERT INTO t5 VALUES(NULL, NULL);
            CREATE TABLE t6(a COLLATE binary, b COLLATE unicode_s1);
...
test:do_execsql_test(
    ...
    [[
        ...
        CREATE TABLE b3(id PRIMARY KEY, a COLLATE unicode_s1, b COLLATE binary);
...
test:do_execsql_test(
    ...
    [[
        ...
        CREATE TABLE h2(id primary key, x COLLATE unicode_s1);
...
test:do_select_tests(
    "e_select-5.6",
    {
        ...
        {"2", "SELECT DISTINCT b COLLATE unicode_s1 FROM h1", {"one", "I", "four", "IV"}},
...
test:do_execsql_test(
    "e_select-7.10.0",
    [[
        CREATE TABLE y1(a COLLATE unicode_s1 PRIMARY KEY, b COLLATE binary, c);
...
test:do_select_tests(
    "e_select-7.10",
    {
        ...
        {"2", "SELECT 'abc' COLLATE unicode_s1 UNION SELECT 'ABC'", {"ABC" }},
        {"3", "SELECT 'abc'                UNION SELECT 'ABC' COLLATE unicode_s1", {"ABC" }},
        {"4", "SELECT 'abc' COLLATE binary UNION SELECT 'ABC' COLLATE unicode_s1", {"ABC",  "abc"}},
        {"5", "SELECT 'abc' COLLATE unicode_s1 UNION SELECT 'ABC' COLLATE binary", {"ABC" }},
...
test:do_execsql_test(
    ...
    [[
        ...
        CREATE TABLE d4(id primary key, x COLLATE unicode_s1);
...
test:do_execsql_test(
    "e_select-8.9.2",
    [[
        SELECT x COLLATE binary FROM d4 ORDER BY 1 COLLATE unicode_s1
    ]], {
        -- <e_select-8.9.2>
        "abc", "DEF", "ghi", "JKL"
        -- </e_select-8.9.2>
...
test:do_execsql_test(
    ...
    [[
        ...
        CREATE TABLE d8(x COLLATE unicode_s1 PRIMARY KEY);
        CREATE TABLE d9(y COLLATE unicode_s1 PRIMARY KEY);
