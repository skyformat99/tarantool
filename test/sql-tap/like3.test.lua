...
test:execsql([[
    ...
    CREATE TABLE t1(a PRIMARY KEY,b TEXT COLLATE unicode_s1);
    INSERT INTO t1(a,b)
       VALUES(1,'abc'),
             (2,'ABX'),
             (3,'BCD'),
...
test:execsql([[
    CREATE TABLE t3(x TEXT PRIMARY KEY COLLATE unicode_s1);
...
test:do_execsql_test(
    "like3-4.0",
    [[
        CREATE TABLE t4(x TEXT COLLATE unicode_s1 PRIMARY KEY);
