...
test:do_execsql_test(
    "minmax3-4.2",
    [[
        SELECT max(x COLLATE unicode_s1) FROM t4;
    ]], {
        -- <minmax3-4.2>
        "BCD"
        -- </minmax3-4.2>
...
test:do_execsql_test(
    "minmax3-4.3",
    [[
        SELECT max(x), max(x COLLATE unicode_s1) FROM t4;
    ]], {
        -- <minmax3-4.3>
        "abc", "BCD"
        -- </minmax3-4.3>
...
test:do_execsql_test(
    "minmax3-4.4",
    [[
        SELECT max(x COLLATE binary), max(x COLLATE unicode_s1) FROM t4;
    ]], {
        -- <minmax3-4.4>
        "abc", "BCD"
        -- </minmax3-4.4>
...
test:do_execsql_test(
    "minmax3-4.6",
    [[
        SELECT max(x COLLATE unicode_s1), max(x) FROM t4;
    ]], {
        -- <minmax3-4.6>
        "BCD", "abc"
        -- </minmax3-4.6>
...
test:do_execsql_test(
    "minmax3-4.11",
    [[
        SELECT min(x COLLATE unicode_s1) FROM t4;
    ]], {
        -- <minmax3-4.11>
        "abc"
        -- </minmax3-4.11>
...
test:do_execsql_test(
    "minmax3-4.12",
    [[
        SELECT min(x), min(x COLLATE unicode_s1) FROM t4;
    ]], {
        -- <minmax3-4.12>
        "BCD", "abc"
        -- </minmax3-4.12>
...
test:do_execsql_test(
    "minmax3-4.13",
    [[
        SELECT min(x COLLATE binary), min(x COLLATE unicode_s1) FROM t4;
    ]], {
        -- <minmax3-4.13>
        "BCD", "abc"
        -- </minmax3-4.13>
...
test:do_execsql_test(
    "minmax3-4.15",
    [[
        SELECT min(x COLLATE unicode_s1), min(x) FROM t4;
    ]], {
        -- <minmax3-4.15>
        "abc", "BCD"
        -- </minmax3-4.15>
