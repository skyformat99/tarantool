...
test:do_execsql_test(
    ...
    [[
        EXPLAIN QUERY PLAN
        SELECT DISTINCT a, c, b FROM t1 WHERE a='xyz' COLLATE unicode_s1;
    ]], {
        -- <1.2.2>
        "/B-TREE/"
        -- </1.2.2>
...
test:do_execsql_test(
    ...
    [[
        EXPLAIN QUERY PLAN
        SELECT DISTINCT a COLLATE unicode_s1, c, b FROM t1 WHERE a='xyz';
    ]], {
        -- <1.2.3>
        "/B-TREE/"
        -- </1.2.3>
...
test:do_execsql_test(
    ...
    [[
        EXPLAIN QUERY PLAN
        SELECT DISTINCT a COLLATE unicode_s1, c, b FROM t1 WHERE a='xyz' COLLATE unicode_s1;
    ]], {
        -- <1.2.4>
        "~/B-TREE/"
        -- </1.2.4>
