...
test:do_execsql_test(
    "selectA-1.0",
    [[
        CREATE TABLE t1(id primary key, a,b,c COLLATE unicode_s1);
...
test:do_execsql_test(
    "selectA-1.1",
    [[
        CREATE TABLE t2(id primary key, x,y,z COLLATE unicode_s1);
...
test:do_execsql_test(
    "selectA-1.2",
    [[
        CREATE TABLE t3(id primary key, a,b,c COLLATE unicode_s1);
...
test:do_execsql_test(
    ...
    [[
        SELECT a,b,c FROM t1 UNION ALL SELECT x,y,z FROM t2
        ORDER BY b COLLATE unicode_s1,a,c
    ]], {
        -- <selectA-2.5>
...
test:do_execsql_test(
    ...
    [[
        SELECT a,b,c FROM t1 UNION ALL SELECT x,y,z FROM t2
        ORDER BY b COLLATE unicode_s1 DESC,a,c
    ]], {
        -- <selectA-2.6>
...
test:do_execsql_test(
    ...
    [[
        SELECT x,y,z FROM t2 UNION SELECT a,b,c FROM t1
        ORDER BY y COLLATE unicode_s1,x,z
    ]], {
        -- <selectA-2.35>
        1, "a", "a", 9.9, "b", "B", "", "C", "c", "hello", "d", "D", "abc", "e", "e", "hare", "m", "M", "", "U", "u", 5200000.0, "X", "x", -23, "Y", "y", "mad", "Z", "z"
        -- </selectA-2.35>
...
test:do_execsql_test(
    ...
    [[
        SELECT x,y,z FROM t2 UNION SELECT a,b,c FROM t1
        ORDER BY y COLLATE unicode_s1 DESC,x,z
    ]], {
        -- <selectA-2.36>
        "mad", "Z", "z", -23, "Y", "y", 5200000.0, "X", "x", "", "U", "u", "hare", "m", "M", "abc", "e", "e", "hello", "d", "D", "", "C", "c", 9.9, "b", "B", 1, "a", "a"
        -- </selectA-2.36>
...
do_same_test(
    5.2,
    [[
      SELECT a, b FROM t8 UNION SELECT c, d FROM t9 ORDER BY a COLLATE unicode_s1
    ]],
    {[[
      SELECT a, b FROM t8 UNION SELECT c, d FROM t9 ORDER BY t8.a COLLATE unicode_s1
    ]], [[
      SELECT a, b FROM t8 UNION SELECT c, d FROM t9 ORDER BY 1 COLLATE unicode_s1
    ]], [[
      SELECT a, b FROM t8 UNION SELECT c, d FROM t9 ORDER BY c COLLATE unicode_s1
    ]], [[
      SELECT a, b FROM t8 UNION SELECT c, d FROM t9 ORDER BY t9.c COLLATE unicode_s1
    ]]})
    do_same_test(5.3,
        [[
      SELECT a, b FROM t8 EXCEPT SELECT c, d FROM t9 ORDER BY b, c COLLATE unicode_s1
    ]],
        {[[
      SELECT a, b FROM t8 EXCEPT SELECT c, d FROM t9 ORDER BY 2, 1 COLLATE unicode_s1
    ]], [[
      SELECT a, b FROM t8 EXCEPT SELECT c, d FROM t9 ORDER BY d, a COLLATE unicode_s1
    ]], [[
      SELECT a, b FROM t8 EXCEPT SELECT c, d FROM t9 ORDER BY t9.d, c COLLATE unicode_s1
    ]], [[
      SELECT a, b FROM t8 EXCEPT SELECT c, d FROM t9 ORDER BY d, t8.a COLLATE unicode_s1
    ]]})

test:do_catchsql_test(
    5.4,
    [[
        SELECT a, b FROM t8 UNION SELECT c, d FROM t9 ORDER BY a+b COLLATE unicode_s1
    ]], {
        -- <5.4>
