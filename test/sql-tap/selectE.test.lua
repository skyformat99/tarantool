...
test:do_test(
    ...
    function()
        return test:execsql [[
            ...
            SELECT a COLLATE unicode_s1 FROM t2 EXCEPT SELECT a FROM t3
             ORDER BY 1
        ]]
    end, {
        -- <selectE-2.1>
...
test:do_catchsql_test(
    "selectE-3.1",
    [[
        SELECT 1 EXCEPT SELECT 2 ORDER BY 1 COLLATE unicode_s1 EXCEPT SELECT 3;
    ]], {
        -- <selectE-3.1>
