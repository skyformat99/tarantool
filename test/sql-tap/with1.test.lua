...
test:do_execsql_test("10.8.4.1", [[
  ...
  SELECT a COLLATE unicode_s1 FROM tst UNION ALL SELECT b FROM tst ORDER BY 1;
]], {
  -- <10.8.4.1>
  "a", "A", "b", "B", "c", "C"
  -- </10.8.4.1>
...
test:do_execsql_test("10.8.4.2", [[
  SELECT a FROM tst UNION ALL SELECT b COLLATE unicode_s1 FROM tst ORDER BY 1;
]], {
  -- <10.8.4.2>
  "A", "B", "C", "a", "b", "c"
  -- </10.8.4.2>
